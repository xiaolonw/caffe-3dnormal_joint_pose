...
Layer<Dtype>* GetLayer(const LayerParameter& param) {
  ...
  case LayerParameter_LayerType_POSE_IMAGE_DATA:
      return new PoseImageDataLayer<Dtype>(param);
  case LayerParameter_LayerType_LABEL_DROPOUT:
      return new LabelDropoutLayer<Dtype>(param);
