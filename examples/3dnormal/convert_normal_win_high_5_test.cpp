...
bool MyReadImageToDatum(const string& filename, const string &filename2, const string &filename3, const string &filename4, const string &filename5, const string &filename6,  const std::vector<float> & label,
...
pFile = fopen(filename6.c_str(), "rb");
for (int c = 0; c < 3; ++c)
{
	for (int h = 0; h < cv_img.rows; ++h)
	{
