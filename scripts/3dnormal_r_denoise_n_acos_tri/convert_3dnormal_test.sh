...
GLOG_logtostderr=1 $rootfolder/build/examples/3dnormal/convert_normalReg.bin /nfs/hn46/xiaolonw/cnncode/viewer/croptest /nfs/hn46/xiaolonw/cnncode/viewer/train_test_3dnormal_reg/smallTestLabels.txt $rootfolder/models/3d_test_db_small_tri 0 0 55 55 /nfs/hn46/xiaolonw/cnncode/viewer/genTestforReg/reg_test_tri
