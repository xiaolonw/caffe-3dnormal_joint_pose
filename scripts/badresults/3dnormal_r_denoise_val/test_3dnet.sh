...
GLOG_logtostderr=1 $ROOTFILE/build/tools/test_net_3dnormal_reg.bin $ROOTFILE/prototxt/3dnormal_reg_denoise/seg_test_2fc_3dnormal.prototxt /nfs/ladoga_no_backups/users/xiaolonw/3dnormal_data/models_reg_val/3dnormal__iter_190000  /nfs/hn46/xiaolonw/cnncode/viewer/train_test_3dnormal_reg/dbTestLabels_small.txt   $ROOTFILE/3dnormal_result_small/denoise_val
