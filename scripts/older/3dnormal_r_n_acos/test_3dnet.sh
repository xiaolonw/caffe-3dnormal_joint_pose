...
GLOG_logtostderr=1 $ROOTFILE/build/tools/test_net_3dnormal_reg.bin $ROOTFILE/prototxt/3dnormal_reg_n_acos/seg_test_2fc_3dnormal.prototxt $ROOTFILE/models/3d_normal_db_r_n_acos/3dnormal__iter_170000  /nfs/hn46/xiaolonw/cnncode/viewer/train_test_3dnormal_reg/dbTestLabels_small.txt   $ROOTFILE/3dnormal_result_small/acosnormOutput
