...
ifeq ($(HOSTNAME), compute-0-5)
	INCLUDE_DIRS += ./src ./include $(CUDA_INCLUDE_DIR) \
					/usr/include/leveldb/ \
					/usr/include \
					/home/xiaolonw/opencv/include \
                                        /home/xiaolonw/opencv/include/opencv \
					/home/xiaolonw/mdb/libraries/liblmdb
	LIBRARY_DIRS += $(CUDA_LIB_DIR) \
					/usr/lib /usr/lib64 \
					/home/xiaolonw/opencv/lib \
					/home/xiaolonw/mdb/libraries/liblmdb \
					/opt/glog/lib
	...
	LIBRARIES := cudart cublas curand \
				pthread \
				glog jpeg protobuf leveldb snappy \
				lmdb \
				boost_system \
				hdf5_hl hdf5 \
				opencv_core opencv_highgui opencv_imgproc \
...
ifeq ($(BLAS), mkl)
	...
	ifeq ($(LINUX), 1)
		ifeq ($(BLAS), atlas)
			...
			BLAS_INCLUDE += /opt/atlas/mt/include /opt/atlas/st/include
			BLAS_LIB += /opt/atlas/mt/lib /opt/atlas/st/lib
		else
		endif
	else ifeq ($(OSX), 1)
